...
public class Preguntas {
     public static Map crearLista(){
        ...
        map.put(66, "Cual es la forma incorrecta de pasar un string a minusculas? \na)tolowerCase(). \nb)tolowercase(). \nc)ToLowerCase(). \nd).Ninguna es correcta" );
        map.put(67, "Cual es la forma incorrecta de pasar un string a mayusculas? \na)toupperCase(). \nb)touppercase(). \nc)ToUpperCase(). \nd).Ninguna es correcta");
        map.put(68, "Existe el split()? \na)Existe en StringBuilder. \nb)No en String. \nc)No existe. \nd)Si en String.");
        map.put(69, "Como comparamos (por ejemplo en un if) dos Strings? \na)Con un ==. \nb)Con un compareTo(). \nc)No se puede. \nd)Con equals()");
        map.put(70, "length() en un String que nos da? \na)Los caracteres del String. \nb)El codigo asscii del String. \nc)No nos da nada. \nd)La longitud del String.");
        return map;
    }
      ...
      boolean correcion = false;
        switch (code){
            ...
            case 30:
                ...
                switch (respuesta){
                    case "c":
                        JOptionPane.showMessageDialog(null, "Correctooooo");
                        correcion = true;
                        break;
                    case "d":
                    case "a":
